 ...
 */
final class Version20200111204746 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('COMMENT ON COLUMN work_projects_task_changes.actor_id IS \'(DC2Type:work_members_group_id)\'');
        ...
        $this->addSql('COMMENT ON COLUMN work_projects_task_changes.set_executor_id IS \'(DC2Type:work_members_group_id)\'');
        $this->addSql('COMMENT ON COLUMN work_projects_task_changes.set_revoked_executor_id IS \'(DC2Type:work_members_group_id)\'');
