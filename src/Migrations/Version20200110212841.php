 ...
 */
final class Version20200110212841 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('COMMENT ON COLUMN work_projects_task_files.member_id IS \'(DC2Type:work_members_group_id)\'');
